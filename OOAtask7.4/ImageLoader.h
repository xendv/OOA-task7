...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->выходToolStripMenuItem->Click += gcnew System::EventHandler(this, &ImageLoader::выходToolStripMenuItem_Click);
			// 
			...
			this->загрузитьToolStripMenuItem->Click += gcnew System::EventHandler(this, &ImageLoader::загрузитьToolStripMenuItem_Click);
			// 
			...
			this->вФорматеJPGToolStripMenuItem->Click += gcnew System::EventHandler(this, &ImageLoader::вФорматеJPGToolStripMenuItem_Click);
			// 
			...
			this->вФорматеPNGToolStripMenuItem->Click += gcnew System::EventHandler(this, &ImageLoader::вФорматеPNGToolStripMenuItem_Click);
			// 
			// toolStrip
			// 
			...
			this->toolStripButton1->Text = L"Открыть в новом окне";
			...
			this->toolStripButton2->Text = L"Загрузить в формате JPG";
			...
			this->toolStripButton3->Text = L"Загрузить в формате PNG";
...
#pragma endregion
	...
	private: System::Void toolStripButton1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		//вызываем форму в модальном режиме
		PreviewF->ShowDialog();
	}
	};
